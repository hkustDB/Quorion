create or replace TEMP view aggView4175807585068549620 as select src as v6, SUM(dst) as v11, COUNT(*) as annot, dst as v8 from epinions as g4 group by src,dst;
create or replace TEMP view aggJoin3314692251595276601 as select src as v4, dst as v6, v11, v8, annot from epinions as g3, aggView4175807585068549620 where g3.dst=aggView4175807585068549620.v6;
...
create or replace TEMP view aggJoin8733448582356401994 as select src as v2, v11, v10, v8, annot from epinions as g2, aggView205492719017449698 where g2.dst=aggView205492719017449698.v4;
...
create or replace TEMP view aggView7179948322801388916 as select dst as v2, SUM(src) as v12, COUNT(*) as annot, src as v1 from epinions as g1 group by dst,src;
