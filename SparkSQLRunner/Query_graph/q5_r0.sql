create or replace TEMP view g4 as select epinions.src as v7, epinions.dst as v2, v16 from epinions, (SELECT dst, COUNT(*) AS v16 FROM epinions GROUP BY dst) AS c3 where epinions.src = c3.dst;
...
create or replace TEMP view joinView4077016006782052883 as select src as v2, dst as v4, mfL7785919405186192751 from epinions AS g2, minView2075684770041518329 where g2.src=minView2075684770041518329.v2;
create or replace TEMP view g1 as select epinions.src as v1, epinions.dst as v2, v12 from epinions, (SELECT src, COUNT(*) AS v12 FROM epinions GROUP BY src) AS c1 where epinions.src = c1.src;
...
create or replace TEMP view g5 as select epinions.src as v4, epinions.dst as v10, v18 from epinions, (SELECT dst, COUNT(*) AS v18 FROM epinions GROUP BY dst) AS c4 where epinions.dst = c4.dst;
...
create or replace TEMP view g3 as select epinions.src as v4, epinions.dst as v6, v14 from epinions, (SELECT src, COUNT(*) AS v14 FROM epinions GROUP BY src) AS c2 where epinions.dst = c2.src;
