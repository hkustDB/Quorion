...
create or replace TEMP view semiJoinView3490531790439417022 as select v4, v9, v10, v14 from g3 where (v4) in (select v4 from semiJoinView444966550382830414);
create or replace TEMP view semiEnum8393246556235228363 as select v2, v14, v10, v9, v12, v4 from semiJoinView3490531790439417022 join semiJoinView444966550382830414 using(v4);
create or replace TEMP view semiEnum30757211987272603 as select v2, v10, v9, v4, v14, v8, v12, v7 from semiEnum8393246556235228363 join g1 using(v2);
